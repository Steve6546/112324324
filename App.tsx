...
import { hasValidApiKey } from './components/ApiKeyModal'; // Keep helper if needed, or move logic to utils
    ...
    return (
        <div className="relative min-h-screen w-full bg-black text-white selection:bg-blue-500/30 overflow-hidden font-sans">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <header className="px-8 py-6 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className={`text-xs px-3 py-1.5 rounded-full border transition-all ${hasKey
                ...
                {/* API Key Warning */}
                {!hasKey && (
                    <div className="mx-8 mb-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-xl flex items-center gap-3 animate-fade-in cursor-pointer hover:bg-yellow-500/15 transition-colors" onClick={() => setShowSettingsModal(true)}>
                        <AlertTriangle size={18} className="text-yellow-500 shrink-0" />
                        <div className="text-sm">
                            <span className="text-yellow-200 font-medium">API Key Required:</span>
                            <span className="text-yellow-100/70 ml-1">
                                Click here to configure your Gemini API key and enable AI features.
                            </span>
                        </div>
                    </div>
                )}
